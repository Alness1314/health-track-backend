package com.alness.health.profiles.controller;
...
public class ProfileController {
    ...
    public ResponseEntity<ResponseDto> saveAll(@RequestBody List<ProfileRequest> request) {
        ResponseDto response = profileService.multiSaving(request);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
}
