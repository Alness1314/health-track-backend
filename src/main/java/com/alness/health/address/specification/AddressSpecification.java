package com.alness.health.address.specification;
...
public class AddressSpecification implements Specification<AddressEntity>{
    ...
    @Override
    @Nullable
    public Predicate toPredicate(Root<AddressEntity> root, @Nullable CriteriaQuery<?> query,
    ...
    public Specification<AddressEntity> getSpecificationByFilters(Map<String, String> parameters) {
        Specification<AddressEntity> specification = Specification.where(this.filterByErased("false"));
