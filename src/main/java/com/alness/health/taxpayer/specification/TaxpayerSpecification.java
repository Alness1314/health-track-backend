package com.alness.health.taxpayer.specification;
...
public class TaxpayerSpecification implements Specification<TaxpayerEntity> {
    ...
    @Override
    @Nullable
    public Predicate toPredicate(Root<TaxpayerEntity> root, @Nullable CriteriaQuery<?> query,
            CriteriaBuilder criteriaBuilder) {
        return null;
    }

    public Specification<TaxpayerEntity> getSpecificationByFilters(Map<String, String> parameters) {
        Specification<TaxpayerEntity> specification = Specification.where(this.filterByErased("false"));
