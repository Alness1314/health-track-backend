package com.alness.health.states.specification;
...
public class StateSpecification implements Specification<StateEntity>{
    ...
    @Override
    @Nullable
    public Predicate toPredicate(Root<StateEntity> root, @Nullable CriteriaQuery<?> query,
            CriteriaBuilder criteriaBuilder) {
        return null;
    }

    public Specification<StateEntity> getSpecificationByFilters(Map<String, String> parameters) {
        Specification<StateEntity> specification = Specification.where(this.filterByErased("false"));
