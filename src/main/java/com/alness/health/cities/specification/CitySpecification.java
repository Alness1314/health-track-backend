package com.alness.health.cities.specification;
...
public class CitySpecification implements Specification<CityEntity> {
    ...
    @Override
    @Nullable
    public Predicate toPredicate(Root<CityEntity> root, @Nullable CriteriaQuery<?> query,
            CriteriaBuilder criteriaBuilder) {
        return null;
    }

    public Specification<CityEntity> getSpecificationByFilters(Map<String, String> parameters) {
        Specification<CityEntity> specification = Specification.where(this.filterByErased("false"));
