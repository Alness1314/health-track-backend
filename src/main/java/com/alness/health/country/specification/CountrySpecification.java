package com.alness.health.country.specification;
...
public class CountrySpecification implements Specification<CountryEntity> {
    ...
    @Override
    @Nullable
    public Predicate toPredicate(Root<CountryEntity> arg0, @Nullable CriteriaQuery<?> arg1, CriteriaBuilder arg2) {
        return null;
    }

    public Specification<CountryEntity> getSpecificationByFilters(Map<String, String> parameters) {
        Specification<CountryEntity> specification = Specification.where(this.filterByErased("false"));
